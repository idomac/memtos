...
insert into s_role values(1, 'admin', '超级管理员', '11,21,31,41,51,52,16', true);
...
insert into s_resource values(16, '应用管理', 'menu', '/app', 1, '0/1/', 'app:*', true);
insert into s_resource values(17, '应用新增', 'button', '', 16, '0/1/16/', 'app:create', true);
insert into s_resource values(18, '应用修改', 'button', '', 16, '0/1/16/', 'app:update', true);
insert into s_resource values(19, '应用删除', 'button', '', 16, '0/1/16/', 'app:delete', true);
insert into s_resource values(20, '应用查看', 'button', '', 16, '0/1/16/', 'app:view', true);

insert into s_resource values(52, '授权管理', 'menu', '/authorization', 1, '0/1/', 'authorization:*', true);
insert into s_resource values(53, '授权新增', 'button', '', 52, '0/1/51/', 'authorization:create', true);
insert into s_resource values(54, '授权修改', 'button', '', 52, '0/1/51/', 'authorization:update', true);
insert into s_resource values(55, '授权删除', 'button', '', 52, '0/1/51/', 'authorization:delete', true);
insert into s_resource values(56, '授权查看', 'button', '', 52, '0/1/51/', 'authorization:view', true);
