package com.quanix.memtos.server.plugin.search.utils;

import com.google.common.collect.Lists;
import com.quanix.memtos.server.plugin.search.SearchOperator;
import com.quanix.memtos.server.plugin.search.Searchable;
import com.quanix.memtos.server.plugin.search.exception.InvalidSearchPropertyException;
import com.quanix.memtos.server.plugin.search.exception.InvalidSearchValueException;
import com.quanix.memtos.server.plugin.search.exception.SearchException;
import com.quanix.memtos.server.plugin.search.filter.AndCondition;
import com.quanix.memtos.server.plugin.search.filter.Condition;
import com.quanix.memtos.server.plugin.search.filter.OrCondition;
import com.quanix.memtos.server.plugin.search.filter.SearchFilter;
